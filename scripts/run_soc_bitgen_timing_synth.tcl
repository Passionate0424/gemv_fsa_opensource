# =============================================================================
# run_soc_bitgen_timing_synth.tcl - SoC bitstream生成（综合阶段时序优化变体）
# =============================================================================
# 与 run_soc_bitgen.tcl 的区别：
#   - synth_design directive: Default（时序优先）替代 AreaOptimized_medium（面积优先）
#   - 无 -retiming 标志
# 目的：验证综合阶段时序优化对板上精度的影响
# =============================================================================
